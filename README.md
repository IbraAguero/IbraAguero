<h1>Hello! I'm Ibrahim <img src="https://raw.githubusercontent.com/iampavangandhi/iampavangandhi/master/gifs/Hi.gif" width="30px"></h1>
<h2>FullStack Developer 💻</h2>

### About Me
- 👋 I'm 23 years old and from Santiago del Estero, Argentina.  
- 💻 Fullstack Developer with a strong focus on **Frontend (React, Next.js)** and solid experience working with **Backend technologies (Node.js, Prisma, PostgreSQL, MongoDB)**.  
- 🚀 Passionate about building modern web applications, from clean and engaging user interfaces to reliable server-side solutions.  
- 🏋️‍♂️ Outside of coding, I practice powerlifting and enjoy pushing myself to new challenges.  
